...
$txt['help_edit_disable_time'] = 'Anzahl in Minuten, nach denen ein Benutzer seine eigenen Beiträge noch bearbeiten kann. Den Wert auf 0 setzen, um die Funktion zu deaktivieren.<br /><br /><em>Beachte: diese Option hat keinen Einfluss auf die Benutzer, welche Beiträge anderer Mitglieder (Beiträge bearbeiten) bearbeiten dürfen, oder explizit diese Funktion umgehen dürfen (Bearbeitungssperre deaktivieren).</em>';
